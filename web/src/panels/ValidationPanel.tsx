...
/** The verdict line is the point — readable at a glance —
 ...
 * disease that doesn't survive both nulls, not
 * hidden, not dramatized either. Content fades on disease switch;
